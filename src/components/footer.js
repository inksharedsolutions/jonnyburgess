...
import FooterLogo from '../assets/img/icon-logo/logo1.png';
			...
			<div className="container">
				<div className="columns navlist-footer-column">
					<div className="column text-center trademark-heading">
						...
						<p>
                            Jonny Burgess loves to hear from readers. You can reach him via email. Feel free to send
				...
				<div className="columns">
					...
					<div className="column text-center trademark-heading">
						<nav id="style_soc_medias">
							...
							<a
								href="https://www.goodreads.com/author/show/6017876.Jonny_Burgess"
								target="_blank"
								rel="noopener noreferrer"
							>
